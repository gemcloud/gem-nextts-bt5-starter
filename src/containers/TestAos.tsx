...
export default function TestAos() {
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.description} data-aos="fade-in" data-aos-delay="1000">
          Get started by editing{` `}
          <code className={styles.code}>pages/index.js</code>
        </p>

        <p className={styles.description} data-aos="fade-in" data-aos-delay="1200">
        ...
        <p className={styles.description} data-aos="fade-in" data-aos-delay="1700">
          Animations Examples
        </p>
